  ...
  <div class="ai-container">
    ...
    >
      <el-descriptions v-if="currentTask" :column="2" border>
        ...
        <el-descriptions-item label="费用">${{ currentTask.cost?.toFixed(4) || '0.0000' }}</el-descriptions-item>
...
import { Setting, Switch, DataLine, Refresh, ChatLineSquare, Coin, Clock, CircleCheck, List } from '@element-plus/icons-vue'
